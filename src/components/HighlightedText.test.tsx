...
describe('HighlightedText', () => {
  ...
  describe('highlighting', () => {
    it('should highlight single match at start', () => {
      const { container } = render(<HighlightedText text="Hello World" searchQuery="Hello" />);
      ...
      const nonHighlightedSpan = Array.from(spans).find(span => span.textContent === ' World');
    ...
    it('should highlight single match at end', () => {
      ...
      // Check that the non-highlighted part exists as a span
      const spans = container.querySelectorAll('span');
      const nonHighlightedSpan = Array.from(spans).find(span => span.textContent === 'Hello ');
      expect(nonHighlightedSpan).toBeInTheDocument();
      expect(nonHighlightedSpan?.tagName).toBe('SPAN');
    });
    ...
    it('should handle special characters in query', () => {
      render(<HighlightedText text="user@example.com" searchQuery="@example" />);
    ...
    it('should handle partial word matches', () => {
      const { container } = render(<HighlightedText text="testing" searchQuery="test" />);
      ...
      // Check that the non-highlighted part exists as a span
      const spans = container.querySelectorAll('span');
      const nonHighlightedSpan = Array.from(spans).find(span => span.textContent === 'ing');
      expect(nonHighlightedSpan).toBeInTheDocument();
      expect(nonHighlightedSpan?.tagName).toBe('SPAN');
    });
